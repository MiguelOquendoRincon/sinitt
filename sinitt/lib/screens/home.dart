...
class _HomePageState extends State<HomePage> {
  ...
  void _onStyleLoaded(){
    ...
    addImageFromAsset("fotoDeteccion", "assets/images/icono-capa-fotodeteccion.png");
  ...
  void getPermission() async{
    if (await location.serviceEnabled()) {
      ...
      var userHasGPSActive = await location.requestService();
      if(userHasGPSActive){
        var userLocation = await location.getLocation();
        setState(() {
          latitude = userLocation.latitude!;
...
galley of type and scrambled it to make a type specimen book.''',
              ...
              Container(
                ...
                child: Icon(
                  SinittIcons.icono_obstruccion_general_circular,
                  color: Colors.white,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${eventData.properties!.observaciones}',
                      style: textStyles.whiteText(
                        context: context,
                        fontSize: ScreenSize.screenWidth * 0.038
                      )
